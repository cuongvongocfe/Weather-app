...
import { GiModernCity, GiMountainRoad, GiIsland, GiPagoda, GiBeach } from "react-icons/gi";
...
const SearchBar = ({ onSearch, inputRef }) => {
  ...
  const popularCities = [
    ...
    { name: "Đà Nẵng", region: "Miền Trung", icon: GiBeach },
      ...
      >
        ...
        `}>
          ...
          <button
            ...
            onClick={() => {}}
          >
            <IoLocationSharp className="w-6 h-6 text-white 
                                     group-hover:scale-110 transition-transform" />
          </button>
        </div>
